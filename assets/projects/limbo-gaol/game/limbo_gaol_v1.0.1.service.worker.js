...
/** @type {string} */
const CACHE_VERSION = '1767975005|344579474';
/** @type {string} */
const CACHE_PREFIX = 'Limbo's Gaol-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'limbo_gaol_v1.0.1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["limbo_gaol_v1.0.1.html","limbo_gaol_v1.0.1.js","limbo_gaol_v1.0.1.offline.html","limbo_gaol_v1.0.1.icon.png","limbo_gaol_v1.0.1.apple-touch-icon.png","limbo_gaol_v1.0.1.audio.worklet.js","limbo_gaol_v1.0.1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["limbo_gaol_v1.0.1.wasm","limbo_gaol_v1.0.1.pck"];
