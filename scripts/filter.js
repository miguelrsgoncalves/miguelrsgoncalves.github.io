const filter = (() => {
  ...
  /**
   * Get selected values for a filter group
   * @param {*} group 
   * @returns 
   */
  ...
  return { init, filterProjects, toggleDropdown, closeDropdown, reset, toggleAll, toggleOnly, updateGroup }
})()
